...
import com.deepspring.blueprint.utils.BmiUtil;
...
//           axisY.setMaxLabelChars(200);
    ...
    private void resetData() {
        ...
        final View dialog_view = LayoutInflater.from(this).inflate(R.layout.dialog_inputdata,null);
        ...
        private void setParameters(double delt_weight,double myWeight,double myHeight,long time){
            ...
            tv_update_time.setText(BmiUtil.getSimpleDate(time));
