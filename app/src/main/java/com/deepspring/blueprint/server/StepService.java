package com.deepspring.blueprint.server;
...
import com.deepspring.blueprint.step.algorithm.StepCount;
import com.deepspring.blueprint.step.algorithm.StepValuePassListener;
...
//                    Logger.d("重置步数" + StepDcretor.CURRENT_STEP);
    ...
    private void remindNotify() {
        ...
        String plan = this.getSharedPreferences("share_date", Context.MODE_MULTI_PROCESS).getString("planWalk_QTY", "6000");
